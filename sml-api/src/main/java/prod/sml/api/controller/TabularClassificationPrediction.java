...
public class TabularClassificationPrediction {
    public static void main(String[] args) throws IOException {
        ...
        predictTabularClassification(project, endpointId, instance);
    }

    static List<? extends Serializable> predictTabularClassification(String project, String endpointId, String instance)
            throws IOException {
